...
#V2X for Network2-->We have used sumo software to make the simulation this code we have integrated with randomtrips file to achieve V2X simulation in SUMO software 
