...
#V2X along with Lane Management System for Network1-->We have used sumo software to make the simulation this code we have integrated with randomtrips file to achieve V2X simulation in SUMO software 
